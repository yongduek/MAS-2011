...
# convert() is used to convert the pygame.Surface to the same pixel format 
# as the one you use for final display, the same one created from 
# pygame.display.set_mode(). 
# If you don't call it, then every time you blit a surface to your display
