...
while not done:
    ...
    for event in pygame.event.get():
        ...
        # 키가 눌릴 경우
        elif event.type == pygame.KEYDOWN: # ASWD keys instead of arrow keys ! Assignment
    ...
    if keyboard_x + keyboard_image_width > WINDOW_WIDTH:
        keyboard_x = WINDOW_WIDTH - keyboard_image_width
